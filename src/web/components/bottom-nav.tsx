...
export function BottomNav() {
  const { t } = useI18n()
  const items = [
    { to: '/', label: t('nav.dashboard'), Icon: DashboardIcon, exact: true },
    { to: '/discover', label: t('nav.discover'), Icon: DiscoverIcon, exact: false },
    { to: '/search', label: t('nav.search'), Icon: DiscoverIcon, exact: false },
    { to: '/genres', label: t('nav.genres'), Icon: GenresIcon, exact: false },
    { to: '/settings', label: t('nav.settings'), Icon: SettingsIcon, exact: false },
  ]
  return (
    <nav
