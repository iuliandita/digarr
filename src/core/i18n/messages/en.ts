export const en = {
  ...
  'recommendation.retryFailed': 'Retry failed',
  ...
  'discover.approvePartial': 'Added to {0} of {1} targets. Failed: {2}',
  'discover.approveAllFailed': 'Could not add to any target. Failed: {0}',
  'discover.retrySucceeded': 'Failed targets added successfully',
  ...
  'pipeline.stop': 'Stop scan',
  'pipeline.stopping': 'Stopping...',
  'pipeline.cancelled': 'Scan stopped',
  ...
  'discoveryMode.tidal-favorite-artists.label': 'TIDAL Favorite Artists',
  'discoveryMode.tidal-favorite-artists.description':
    'Discover from the artists in your TIDAL collection',
  'discoveryMode.reason.connectTidal': 'Connect TIDAL to use this mode.',
  ...
  'settings.tidalConnectHelp':
    'Connect your TIDAL account to seed discovery from your favorite artists.',
  'settings.tidalAppNotConfigured':
    'An administrator must configure the TIDAL app credentials first.',
  'settings.connectTidal': 'Connect TIDAL',
  'settings.tidalConnected': 'Your TIDAL favorite artists are available as a discovery source.',
  'settings.tidalDisconnected': 'TIDAL disconnected',
  'settings.tidalDisconnectFailed': 'Failed to disconnect TIDAL',
  'settings.tidalAuthorizationFailed': 'Failed to start TIDAL authorization',
  ...
  'settings.targetUser': 'Assigned user',
  ...
  'settings.emailTaken': 'That email is already in use',
  ...
  'settings.fieldPassword': 'Password',
  ...
  'settings.fieldRedirectUri': 'Redirect URI',
  'settings.redirectUriHelp':
    'Add this exact URL to your Spotify app under Redirect URIs before connecting.',
  'settings.copyRedirectUri': 'Copy redirect URI',
  ...
  'settings.aiSavedTestFailedToast': 'AI settings saved, but the connection test failed',
  ...
  'admin.migrateBackend': 'Migrate Database Backend',
  'admin.migrateIntro':
    'Copy all data to a different backend. The current database is never modified.',
  'admin.migrateTargetBackend': 'Target backend',
  'admin.migratePglitePath': 'PGlite data directory',
  'admin.migratePostgresDsn': 'PostgreSQL connection string',
  'admin.migrateTestConnection': 'Test connection',
  'admin.migrateConnectionOk': 'Connected to {0}',
  'admin.migrateConnectionFailed': 'Connection failed',
  'admin.migrateErrUnreachable': 'Target unreachable: host or port refused the connection',
  'admin.migrateErrAuthFailed': 'Authentication failed: check the username and password',
  'admin.migrateErrTimeout': 'Connection timed out',
  'admin.migrateErrDbMissing': 'Database does not exist on the target',
  'admin.migrateErrInvalidPath': 'Invalid PGlite path',
  'admin.migrateErrUnknown': 'Connection failed for an unknown reason',
  'admin.migrateOverwrite': 'Overwrite target if it already contains data',
  'admin.migrateRun': 'Migrate',
  'admin.migrateConfirmTitle': 'Migrate to a new backend?',
  'admin.migrateConfirmMessage':
    'This copies all data into the target. The current database stays untouched. After it finishes, set the shown environment variable and restart.',
  'admin.migrateRunning': 'Migrating...',
  'admin.migrateSuccess': 'Migrated {0} rows across {1} tables',
  'admin.migrateVerifyFailed': 'Row counts did not match for: {0}',
  'admin.migrateContentMismatch': 'Content did not match for: {0}',
  'admin.migrateExcluded': 'Not copied (transient): {0}',
  'admin.migrateMaintenanceNote': 'Writes are paused during migration.',
  'admin.migrateEnvHint': 'Set this, then restart:',
  'admin.migrateCopyHint': 'Copy',
  'admin.migrateFailed': 'Migration failed',
  ...
  'integration.topArtists': 'Top Artists',
  'integration.yes': 'Yes',
  ...
  'pipeline.message.aiSourceFailed': 'AI provider failed: {0} - continuing without AI suggestions',
  ...
  'pipeline.message.cancelled': 'Scan stopped',
  ...
  'settings.channels.description':
    'Send scan-complete and digest notifications to one or more channels.',
  'settings.channels.add': 'Add channel',
  'settings.channels.empty': 'No channels configured yet.',
  'settings.channels.type': 'Type',
  'settings.channels.enabled': 'Enabled',
  'settings.channels.events': 'Events',
  'settings.channels.eventBatch': 'Scan complete',
  'settings.channels.eventDigest': 'Digest',
  'settings.channels.test': 'Test',
  'settings.channels.testOk': 'Test notification sent',
  'settings.channels.testFailed': 'Test failed: {0}',
  'settings.channels.remove': 'Remove',
  'settings.channels.allowPrivate': 'Allow private network targets',
  'settings.channels.allowPrivateWarning':
    'Permits delivery to private/LAN addresses. Cloud metadata and link-local ranges stay blocked.',
  'settings.channels.webhookUrl': 'Webhook URL',
  'settings.channels.ntfyServer': 'Server',
  'settings.channels.ntfyTopic': 'Topic',
  'settings.channels.ntfyPriority': 'Priority',
  'settings.channels.ntfyToken': 'Access token',
  'settings.channels.telegramBotToken': 'Bot token',
  'settings.channels.telegramChatId': 'Chat ID',
  'settings.channels.appriseEndpoint': 'Apprise API endpoint',
  'settings.channels.appriseUrls': 'Notification URLs',
  'settings.channels.appriseUrlsHelp': 'One Apprise URL per line.',
