export const en = {
  ...
  'errors.auth.sessionExpired': 'Session expired',
  ...
  'errors.auth.registrationClosed': 'Registration is closed',
  'errors.auth.oidcDisabled': 'OIDC is not enabled',
  'errors.validation.invalidInput': 'Invalid input',
  'errors.validation.missingField': 'A required field is missing',
  'errors.target.notFound': 'Target not found',
  'errors.target.addFailed': 'Failed to add artist to target',
  'errors.target.testFailed': 'Target connection test failed',
  'errors.pipeline.alreadyRunning': 'A pipeline run is already in progress',
  'errors.pipeline.rateLimited': 'Too many pipeline runs; try again later',
  'errors.pipeline.notConfigured': 'Pipeline is not configured yet',
  ...
  'errors.backup.restoreFailed': 'Backup restore failed',
